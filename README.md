...
**Автор:** Beksultan Zhaslan & Darina Nakhrad
...
Особенности • Установка • API Docs • Архитектура • Демо
</div>
📖 Содержание
...
🔐 Настройка Gmail App Password:
    ...
    Откройте "App passwords" (Пароли приложений)
    Выберите "Mail" → "Other (Custom name)"
    Введите "VoteGolang" и нажмите "Generate"
    Скопируйте пароль в SMTP_PASSWORD
...
Доступ к логам
    ...
    Создайте паттерн: vote-logs-*
    Выберите Time Field: @timestamp
...
Добавление новых endpoints
    ...
    Создайте handler в internals/delivery/http/handlers/
    Добавьте usecase в internals/usecase/
    Зарегистрируйте route в cmd/app/main.go
    Добавьте Swagger комментарии:
...
Проблема: Email не отправляются
    ...
    Проверьте Gmail App Password в .env
